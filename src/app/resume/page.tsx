    ...
    <div className="pt-14 pb-6">
      ...
      <section className="mt-12 print-avoid-break">
        ...
        <p className="no-print mt-4 text-[13px]">
          <Link href="/work#lectures" className="font-semibold text-accent">
            포트폴리오에서 자세히 보기 →
          </Link>
        </p>
      </section>
      ...
      <section className="mt-12">
        ...
        <div className="mt-3 space-y-4 border-t border-hairline pt-3">
          ...
          <p className="text-[12.5px] text-faint">
            ...
            <Link href="/work#research" className="no-print text-accent font-semibold">
              전체 목록은 포트폴리오에서 →
            </Link>
      ...
      {/* 08 기술 스택 */}
      <section className="mt-12 print-avoid-break">
        <SectionHeading no="08" title="기술 스택" />
        <div className="mt-4 space-y-3">
          {skills.map((s) => (
            <div key={s.label} className="flex gap-4">
              <span className="w-24 shrink-0 pt-0.5 text-[12px] font-bold tracking-[0.08em] text-faint">
                {s.label}
              </span>
              <span className="flex-1 text-[13.5px] leading-[1.7] text-muted">
                {s.items.join(" · ")}
              </span>
            </div>
          ))}
