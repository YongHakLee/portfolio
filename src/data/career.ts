...
export const skills: SkillCategory[] = [
  { label: "언어", items: ["Python", "SQL", "TypeScript"] },
  { label: "ML · DL", items: ["PyTorch", "YOLO", "HRNet", "LightGBM"] },
  { label: "3D · 비전", items: ["Mobile LiDAR", "3D Point Cloud", "Open3D", "OpenCV"] },
  { label: "생성 AI", items: ["FLUX", "Claude Code", "MCP"] },
  { label: "백엔드 · 인프라", items: ["FastAPI", "Next.js", "Docker", "Git"] },
];
