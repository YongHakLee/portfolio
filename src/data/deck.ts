...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    lead: "주름은 색이 아니라 골이다 — 2D 음영은 조명 따라 흔들리지만 깊이는 실제 깊이다",
    blocks: [
      {
        kind: "bib",
        rows: [
    ...
    blocks: [
      {
        ...
        items: [
          {
            lead: "2단 랜드마크 (1 · 3항)",
            text: "1차로 눈·코·입 영역을 잡고, 그 영역을 기준으로 부위별 주름 영역을 정할 얼굴 특징점을 2차 랜드마크로 검출한다. 얼굴 크기와 각도가 달라도 부위 정의가 흔들리지 않는다.",
          },
          {
            lead: "주름 영역 결정",
            text: "2D 얼굴 특징점 영상과 3D 깊이 영상을 정합해 포인트 클라우드로 만들고, 주름의 길이·깊이·밀도를 계산해 부위별 영역을 확정한다.",
          },
          {
            lead: "주름 상태 결정",
            text: "그 영역의 포인트 클라우드를 U-Net 기반 주름분석모델에 넣어 주름의 형상을 얻고, 형상 위 구간별 깊이를 함께 산출한다.",
          },
          {
            lead: "응용 (7항)",
            text: "팔자주름의 주름 상태를 얼굴노화분석 모델에 넣어 신체적 나이를 판정한다 — K-뷰티 모바일 피부분석 AI 과제(2025)로 이어졌다.",
          },
        ],
      },
    ],
    figure: "patent2-core",
    note: "논문 목록과 이력은 /work 와 /cv 에",
  },
];
