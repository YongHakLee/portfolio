...
const RgbGap = () => (
  <svg viewBox="0 0 460 132" role="img" aria-labelledby="fig-rgbgap">
    ...
    <text className="fig-em" x="398" y="106">
      ? mm
    </text>
  </svg>
);
...
const SqueezeFace = () => (
  <svg viewBox="0 0 460 130" role="img" aria-labelledby="fig-squeezeface">
    <title id="fig-squeezeface">
      RGB와 깊이맵과 포인트 클라우드를 7채널로 합쳐 SAC 주의 블록이 있는
      ResNet-34에 넣는다
    </title>
    ...
    <text className="fig-em" x="94" y="53">
      7채널 입력
    </text>
    ...
    <text className="fig-em" x="190" y="71">
      SAC Block
    </text>
    ...
    <text className="fig-em" x="414" y="61">
      식별
    </text>
  </svg>
);
...
const CloudNet = () => (
  <svg viewBox="0 0 460 130" role="img" aria-labelledby="fig-cloudnet">
    ...
    <text className="fig-em" x="342" y="96">
      CloudNet
    </text>
  </svg>
);
...
const Garment = () => (
  <svg viewBox="0 0 460 116" role="img" aria-labelledby="fig-garment">
    <title id="fig-garment">
      치수점 두 개, 그리고 픽셀이 아닌 포인트 클라우드 위의 거리
    </title>
    ...
    <text className="fig-em" x="392" y="80">
      cm
    </text>
...
const Body = () => (
  <svg viewBox="0 0 460 116" role="img" aria-labelledby="fig-body">
    ...
    <text className="fig-em" x="0" y="104">
      반둘레 합성
    </text>
...
const Patent1Core = () => (
  <svg viewBox="0 0 460 116" role="img" aria-labelledby="fig-p1core">
    ...
    <text className="fig-em" x="22" y="74">
      중간 지점
    </text>
    ...
    <text className="fig-em" x="342" y="52">
      Σ ‖ pᵢ₊₁ − pᵢ ‖
    </text>
    <text x="342" y="72">
      인접 점 간 유클리드 거리
...
const Patent2Flow = () => (
  <svg viewBox="0 0 460 108" role="img" aria-labelledby="fig-p2flow">
    <title id="fig-p2flow">
      2D 컬러와 3D 깊이를 정합해 부위별 주름 영역을 정한다
    </title>
    ...
    <rect
      ...
      rx="3"
    />
    <text className="fig-em" x="330" y="55">
      부위별 주름 영역
    </text>
    <text x="196" y="86">
      길이 · 깊이 · 밀도로 영역 확정
...
const Patent2Core = () => (
  <svg viewBox="0 0 460 124" role="img" aria-labelledby="fig-p2core">
    ...
    <text className="fig-em" x="0" y="120">
      2차 랜드마크 · 부위별 주름 영역
    </text>
